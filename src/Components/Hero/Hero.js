...
// import profile2 from '../../assest/profile2.jpg'
// import profile3 from '../../assest/profile3.jpg'
      ...
      <div className='hero-top'>
        <div className='hero-top-left'>
            ...
            <div className={`hero-top-left-icon ${dark && 'icon-dark'}`}>
              ...
              <a target='new' href='http://www.linkedin.com/monukumar012'><i className="fa-brands fa-linkedin fa-2xl"></i></a>
      ...
      <div className={`hero-bottom ${dark && 'dark'}`}>
        <div className={`hero-bottom-top ${dark && 'dark'}`}>
            ...
            <div className={`hero-bottom-top-tech`}>
              ...
              <p className='typescript-logo'><BiLogoTypescript/></p>
